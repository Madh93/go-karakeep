...
[`oapi-codegen`](https://github.com/oapi-codegen/oapi-codegen) tool, which allows convert [Karakeep OpenAPI](https://github.com/karakeep-app/karakeep/blob/v0.30.0/packages/open-api/karakeep-openapi-spec.json) specification to Go code.
